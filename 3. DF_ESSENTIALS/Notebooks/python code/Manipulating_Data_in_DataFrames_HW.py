...
md_office = [('Mohammed','Alfasy','1987-4-8','2016-1-7','2017-2-3','2018-3-2')             ,('Marcy','Wellmaker','1986-4-8','2015-1-7','2017-1-3','2018-1-2')             ,('Ginny','Ginger','1986-7-10','2014-8-7','2015-2-3','2016-3-2')             ,('Vijay','Doberson','1988-5-2','2016-1-7','2018-2-3','2018-3-2')             ,('Orhan','Gelicek','1987-5-11','2016-5-7','2017-1-3','2018-9-2')             ,('Sarah','Jones','1956-7-6','2016-4-7','2017-8-3','2018-10-2')             ,('John','Johnson','2017-10-12','2018-1-2','2018-10-3','2018-3-2') ]
...
values = [(5,'Epic. This is the best movie I have EVER seen'),           (4,'Pretty good, but I would have liked to seen better special effects'),           (3,'So so. Casting could have been improved'),           (5,'The most EPIC movie of the year! Casting was awesome. Special effects were so intense.'),           (4,'Solid but I would have liked to see more of the love story'),           (5,'THE BOMB!!!!!!!')]
