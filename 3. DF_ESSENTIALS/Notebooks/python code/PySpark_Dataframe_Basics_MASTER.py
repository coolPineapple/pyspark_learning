...
df.select("first","last").where(df.first.startswith("I"))                                   .where(df.first.endswith("n")).limit(4).toPandas()
...
year = df.withColumn("TRENDING_YEAR",fn.year("trending_date"))          .withColumn("TRENDING_MONTH",fn.month("trending_date"))
#QA
...
purchases = customer.select(array('item1', 'item2','item3').alias("Monday"),                            array('item4', 'item5','item6').alias("Tuesday"))
...
from pyspark.sql.functions import *
values = [(45,'I like to ride bikes'),           (14,'I like chicken'),           (63,'I like bubbles'),           (75,'I like roller coasters'),           (24,'I like shuffle board'),           (45,'I like to swim')]
